...
<style>
#auravis-global-nav{position:relative;z-index:9000;display:flex;gap:5px;flex-wrap:wrap;justify-content:center;width:max-content;max-width:calc(100% - 32px);margin:12px auto 18px;padding:6px;background:rgba(8,20,37,.96);border:1px solid #234469;border-radius:12px;box-shadow:0 8px 28px rgba(0,0,0,.18)}
...
@media(max-width:760px){#auravis-global-nav{width:auto;max-width:none;margin:8px 10px 14px}}
</style>
