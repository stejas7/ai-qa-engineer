...
/** Represents one autonomous end-to-end UAT QA mission. */
@Entity
@Table(name = "scorpion_missions")
public class ScorpionMission {
    ...
    protected ScorpionMission() {}

    public ScorpionMission(String title, String requirement, String uatUrl) {
        this.title = title;
